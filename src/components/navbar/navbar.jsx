           ...
           <div className="container flex flex-wrap items-center justify-between py-4 overflow-hidden">
               ...
               <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                   <div className="flex flex-col items-center cursor-pointer">
                       ...
                       <div className="dropdown-item grid grid-rows-[0fr] md:absolute z-50 top-20 lg:top-[94px] bg-white border-light transition-all ease duration-500">
                           <div className=" text-base max-xs:text-sm overflow-hidden">
                               <ul className="flex flex-col dropdown-list divide-y divide-[#E6E8EC] py-5 px-6 tracking-widest max-lg:text-center text-dark">
                                   <li><a className="transition-all duration-200 nav-link hover:text-darkBlue ease block">uz</a></li>
                                   <li><a className="transition-all duration-200 nav-link hover:text-darkBlue ease block">ru </a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
                   <button onClick={() => setOpenNav(!openNav)} type="button" className="inline-flex items-center p-1  justify-center text-sm text-black rounded-sm md:hidden   focus:outline-none focus:ring-2 focus:ring-black">
                       <CiMenuBurger className={'text-xl'}/>
                   </button>
               </div>
               <div className={`items-center justify-between overflow-hidden h-full bg-white w-full md:flex md:w-auto md:order-1 fixed  duration-500 md:static z-[-1] left-0 ${openNav ? 'top-[57px]' : 'top-[-100%]'} `}>
