    ...
    <div className="w-full bg-darkBlue py-4 text-white font-rubik">
      <div className="container flex items-center justify-between">
        ...
        <div className="flex items-center justify-around max-md:w-full gap-5 lg:gap-10">
          ...
          <div onClick={(e) => handleLanguage(e)} className="lang flex items-center gap-[10px] group cursor-pointer relative z-30">
            ...
            <div className="h-full">
              ...
              <div className={`absolute dropdown-list grid grid-rows-[0fr] duration-300 border-white top-[38px] -right-5 ${dropdown && 'grid-rows-[1fr] border' }`}>
