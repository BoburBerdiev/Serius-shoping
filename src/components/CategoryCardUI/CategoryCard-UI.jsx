...
const CategoryCardUI = ({src,  text,value, textPosition, iconPosition, grid  }) => {
    ...
    <button onClick={FilterCatalog} className={`w-full relative block rounded-lg overflow-hidden group h-[240px] before:w-full  before:h-full before:absolute before:bg-black/20 before:duration-200 hover:before:bg-black/30 before:top-0 before:left-0 before:z-[4] ${grid}`}>
