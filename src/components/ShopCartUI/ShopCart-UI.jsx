  ...
  return (
    <div className='flex justify-between w-full font-rubik max-sm:flex-col items-center gap-2 sm:gap-0 shop-cart relative py-5 sm:py-0'>
      <div className="flex items-center w-full sm:w-auto gap-5">
        ...
        <p className='line-clamp-2	text-sm  md:text-base max-w-[150px] sm:max-w-[160px] xl:max-w-[280px]'>{title}</p>
       ...
       <div className="flex  items-center gap-5 justify-end w-full sm:w-auto">
        <form action="" className='flex px-3 py-1.5 bg-[#F5F5F5] rounded-lg order-2 sm:order-1'>
