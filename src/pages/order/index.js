            ...
            <div className="font-rubik min-h-screen">
                {
                    allCount > 0 ?
                        <div>
                            <SectionUI customPadding={'pt-[60px] md:pt-40 pb-10 font-rubik'}>
                                <BreadcrumbUI/>
                                {
                        ...
                        <div className="">
                            <div
                                ...
                                <div className="relative w-20 h-20 md:w-[134px] md:h-[152px]">
                                    <ImageUI card={true} src={'/empty cart.png'} alt={'card'}
...

                {
                    ...
                    <div
                        ...
                        <div
                            ...
                            <div className="w-1/2">
                                <ButtonUI text={t('btn.sendHome')} cardBtn={true} className={'py-3 md:py-4'}
                                          href={'/'}/>
                            </div>
                        </div>
                    </div>
